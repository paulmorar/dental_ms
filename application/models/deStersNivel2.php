<?php
class Default_Model_DbTable_Nivel2 extends Zend_Db_Table_Abstract
{
	protected $_name    = 'nivel2';
	protected $_primary = 'id_nivel2';
}

class Default_Model_Nivel2
{
	...
	public function getMapper()
	{
            if(null === $this->_mapper) {
                    $this->setMapper(new Default_Model_Nivel2Mapper());
            }
            return $this->_mapper;
	}
...
class Default_Model_Nivel2Mapper
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
            ...
            {
                    $this->setDbTable('Default_Model_DbTable_Nivel2');
            }
            return $this->_dbTable;
	}

	public function find($id, Default_Model_Nivel2 $model)
	{
	...
	public function fetchRow($select, Default_Model_Nivel2 $model)
	{
