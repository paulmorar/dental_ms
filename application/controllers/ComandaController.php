            ...
            if($form->isValid($this->getRequest()->getPost())) 
            {
                ...
                if($id = $model->save()) {     
                    ...
                    if($modelLegatura->save() && $modelDepartament->save()){
                        ...
                        $departament    = Needs_Tools::getDepartamentComandaById($id);

                        Needs_Tools::sendEmail($emailArray,$departament->getIdRole(),$this->getRequest()->getPost('nume'),$client->getEmail());
...
//                    }
                    ...
                    $emailArray = array();
                    $client = Needs_Tools::getClientByComandaId($id);
                    Needs_Tools::sendEmail($emailArray,$utilizator->getIdRole(),$model->getNume(),$client->getEmail());
